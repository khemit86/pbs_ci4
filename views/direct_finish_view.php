									...
									<div class="panel panel-default" style="overflow-x: scroll;">
										...
										<div class="panel-body hidden-xs hidden-sm">
											...
											<?php if(count($client_records) > 0) { 
												...
												echo form_open_multipart(base_url('direct/bulk_action'), $attributes); 
											?>   
													...
													<?php foreach($client_records as $cval) { ?>  
														...
														<tr>
															...
															<td nowrap>  
																...
																<?php /*?>     <a class="bt btn-danger btn-sm" href="<?php echo base_url() ?>direct/save/<?php echo $cval['id']; ?>"><i title="Finalize this record"  class="fa fa-save"></i></a>  
																*/?>
															</td>
											...
											<table style="text-align:center;" class="table">
												...
												<tr>
													...
													<th> <center>No records found.</center></th>
											...
											<div class="form-group col-lg-12 col-xs-12">
												<?php if(count($client_records) > 0) { ?>
													<div class="form-group col-lg-2 col-xs-12">
														<a href="<?php echo base_url() ?>direct/save/<?php echo $id; ?>"><button class="btn btn-primary"> <i class="fa fa-save"></i> Finalize records </button></a>
										...
										<div class="panel-body hidden-lg hidden-md">
														...
														<?php foreach($client_records as $cval) { ?>  
															...
															<tr>
																...
																<td nowrap>   
																	...
																	<a class="bt btn-danger btn-sm" href="<?php echo base_url() ?>direct/save/<?php echo $cval['id']; ?>"><i class="fa fa-save"></i></a>  
											...
											<div class="form-group col-lg-2 col-xs-12">
												<a href="<?php echo base_url('direct'); ?>"><button class="btn btn-primary"> <i class="fa fa-save"></i>  Enter another record </button></a>
											</div>
